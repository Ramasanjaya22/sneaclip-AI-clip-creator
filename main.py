...
app.secret_key = secret_key or 'dev-secret-key-123'
...
def set_cache_headers(response):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.plyr.io https://unpkg.com; img-src 'self' data: blob:; media-src 'self' blob:;"
