...
def set_cache_headers(response):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self'; script-src 'self' https://cdn.plyr.io https://unpkg.com 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://cdn.plyr.io; img-src 'self' data: blob:; media-src 'self' blob:; connect-src 'self';"
